      ...
      <main className="max-w-4xl mx-auto px-8 py-24">
        ...
        <header className="mb-20 space-y-8">
          <div className="text-center">
            <h2 className="text-[#D4A373] tracking-[0.3em] text-sm uppercase mb-4">Psychotherapy</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-12 pt-12">
            {/* Carl Rogers Image Placeholder */}
            <div className="md:col-span-5 flex flex-col items-center">
              <div className="relative w-full aspect-[3/4] border border-[#EBCBCE] p-3 bg-white shadow-sm">
                <div className="w-full h-full bg-[#EBCBCE]/20 relative overflow-hidden flex items-center justify-center">
                  {/* 請在此處更換為 Carl Rogers 的真實照片 */}
                  <span className="text-[#D4A373] text-xs tracking-widest uppercase italic">Image: Carl Rogers</span>
                  {/* <Image src="/path-to-rogers.jpg" alt="Carl Rogers" fill className="object-cover" /> */}
                </div>
              </div>
              <p className="mt-4 text-xl text-[#4A4A4A] font-medium tracking-widest">Carl Rogers</p>
            </div>

            {/* Bio Text */}
            <div className="md:col-span-7 space-y-6 text-justify leading-loose font-light">
              <p>
        ...
        <section className="mb-24">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
            {/* Image Placeholder: Oak/Seed */}
            <div className="order-2 md:order-1 relative aspect-square bg-[#F9F3F4] rounded-full flex items-center justify-center border border-[#EBCBCE]/50 p-8">
               {/* 請在此處放入橡樹或種子的圖片 */}
               <div className="text-center text-[#D4A373]/60 italic">
                  [Image: Acorn / Oak Tree]
               </div>
            </div>

            <div className="order-1 md:order-2 space-y-8">
              <div className="border-l-2 border-[#D4A373] pl-6">
              ...
              <div className="border-l-2 border-[#EBCBCE] pl-6">
        ...
        {/* Influences Section */}
        <section className="mb-24 bg-white p-12 shadow-[0_4px_20px_-10px_rgba(212,163,115,0.2)] border-t border-[#EBCBCE]">
          <h2 className="text-center text-2xl text-[#4A4A4A] mb-12 tracking-widest">誰影響Rogers形成個人中心治療</h2>
          
          <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-16">
            <div className="space-y-3">
              <h4 className="text-[#D4A373] font-bold text-lg border-b border-[#EBCBCE] pb-2 inline-block">Otto Rank</h4>
              <p className="text-sm leading-8 text-[#666] text-justify">
                認為心理治療不應再只談本我、自我、超我，而是要幫助人發揮自己的創造力，學會接納獨特的自己，並勇於對生活負責。治療師不再是高高在上的專家，而是一個真誠、願意陪伴、沒有批判的助人者。
              </p>
            </div>
            <div className="space-y-3">
              <h4 className="text-[#D4A373] font-bold text-lg border-b border-[#EBCBCE] pb-2 inline-block">Alfred Adler</h4>
              <p className="text-sm leading-8 text-[#666] text-justify">
                強調每個人都有自己的價值，而且要與他人建立良好的人際關係。他覺得人是整體的存在，透過創造力和責任感去成長。這種「關心別人、在關係中找到意義」的觀點，也影響了後來的 Rogers。
              </p>
            </div>
            <div className="space-y-3">
              <h4 className="text-[#D4A373] font-bold text-lg border-b border-[#EBCBCE] pb-2 inline-block">Martin Buber</h4>
              <p className="text-sm leading-8 text-[#666] text-justify">
                認為真正的關係是一種「我—你」的互動，不是把別人當作工具，而是把他當作一個完整的人。Rogers 也受到這個觀點啟發，重視「當下的相遇」與「每個人主觀的生命經驗」。
              </p>
            </div>
            <div className="space-y-3">
              <h4 className="text-[#D4A373] font-bold text-lg border-b border-[#EBCBCE] pb-2 inline-block">Abraham Maslow</h4>
              <p className="text-sm leading-8 text-[#666] text-justify">
                Maslow 把自我實現擴展成「需求層次理論」，強調除了基本需求之外，人也渴望愛、創造力，以及那種讓人感到深深滿足與感動的「高峰經驗」。這種看待人性的方式很正向，也被稱為「人本主義」。
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mb-24 text-center space-y-6 py-12 bg-[#F5E6E8]/20 rounded-lg">
          <h3 className="text-2xl text-[#4A4A4A] tracking-wider">全然發揮的人</h3>
          <p className="text-[#666]">全然發揮的人沒有防衛，會開放新經驗而不刻意去控制他們。</p>
          <p className="text-[#D4A373] font-medium text-lg">「自我實現」朝向自我了解，自我成長，自主，自我決定邁進</p>
          <div className="w-12 h-[1px] bg-[#D4A373] mx-auto"></div>
          <p className="italic text-[#555]">深入一個人內在的核心，將會發現存在著一個值得信任，積極正向的心靈</p>
        </section>

        {/* Theory of Self */}
        <section className="mb-24 space-y-12">
          <div className="text-center mb-12">
            <h2 className="text-3xl text-[#4A4A4A] mb-4 font-light">Rogers對人性本質的看法 - 論自我 self</h2>
            <div className="w-24 h-1 bg-gradient-to-r from-transparent via-[#EBCBCE] to-transparent mx-auto"></div>
          </div>

          <div className="flex flex-col md:flex-row gap-12">
             <div className="flex-1 space-y-6 text-justify leading-loose">
                <p>
             ...
             {/* Image Placeholder: Phenomenal Field Diagram */}
             <div className="flex-1 min-h-[300px] border border-dashed border-[#D4A373] bg-[#FDFBFB] flex items-center justify-center p-8">
                <div className="text-center text-[#D4A373]">
                    <span className="block text-2xl mb-2">⊕</span>
                    <span className="uppercase text-xs tracking-widest">Diagram: Phenomenal Field / Self-Structure</span>
                </div>
             </div>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 pt-8">
            <div className="bg-white p-8 border-t-2 border-[#EBCBCE]">
              <h4 className="text-[#D4A373] mb-4 font-bold tracking-wide">每個人的經驗都是獨特的</h4>
            ...
            <div className="bg-white p-8 border-t-2 border-[#D4A373]">
              <h4 className="text-[#D4A373] mb-4 font-bold tracking-wide">自我概念的形成與環境密不可分</h4>
              <p className="text-sm leading-7 text-[#666]">
            ...
            <div className="bg-white p-8 border-t-2 border-[#D4A373]">
              <h4 className="text-[#D4A373] mb-4 font-bold tracking-wide">每個人都具有追求自我實現的傾向</h4>
              <p className="text-sm leading-7 text-[#666]">
            ...
            <div className="bg-white p-8 border-t-2 border-[#EBCBCE]">
              <h4 className="text-[#D4A373] mb-4 font-bold tracking-wide">當人願意改變自己時，行為便有可能轉變</h4>
              <p className="text-sm leading-7 text-[#666]">
          ...
          <div className="bg-[#D4A373]/10 p-8 text-center italic text-[#5D5D5D] leading-relaxed">
            <span className="font-bold not-italic text-[#D4A373] block mb-2">人性是可以被信任的。</span>
        ...
        {/* Becoming Yourself */}
        <section className="mb-24">
          <h2 className="text-3xl text-[#4A4A4A] mb-8 font-light">成為自己</h2>
          <div className="space-y-6 leading-loose text-justify text-[#555]">
            ...
            <div className="py-8">
              <h3 className="text-xl text-[#4A4A4A] mb-4">在勇於當自己的歷程中，Rogers提出了幾個關鍵的轉折。</h3>
              <p>
              ...
              <blockquote className="border-l-4 border-[#EBCBCE] pl-6 my-6 text-[#666] italic">
            ...
            <div>
              <h3 className="text-xl text-[#4A4A4A] mb-4">成為自己，也意味著迎向每一個新的經驗。</h3>
              <p>
              ...
              <blockquote className="border-l-4 border-[#D4A373] pl-6 my-6 text-[#666] italic">
        ...
        <section className="mb-24 grid grid-cols-1 md:grid-cols-2 gap-16">
           {/* Therapy Goals */}
           <div>
             <h2 className="text-2xl text-[#4A4A4A] mb-6 font-light border-b border-[#EBCBCE] pb-2 inline-block">治療目標</h2>
           ...
           <div>
             <h2 className="text-2xl text-[#4A4A4A] mb-6 font-light border-b border-[#D4A373] pb-2 inline-block">治療關係</h2>
             <div className="space-y-4 text-justify text-sm leading-7 text-[#666]">
               <p>
        ...
        {/* 14 Learnings */}
        <section className="mb-24 py-16 bg-[#FDFBFB] relative">
          <div className="absolute inset-0 border-y border-[#EBCBCE]/50 pointer-events-none"></div>
          <h2 className="text-center text-3xl text-[#4A4A4A] mb-12 tracking-wide font-light">Rogers的14項重要學習</h2>
          ...
          <div className="columns-1 md:columns-2 gap-12 space-y-6">
            {[
              ...
              <div key={index} className="break-inside-avoid mb-6 flex gap-4">
                <span className="text-[#D4A373] font-serif italic text-lg">{index + 1}.</span>
        ...
        <footer className="text-center pt-12 pb-8 border-t border-[#D4A373]/20">
           <p className="text-[#999] text-[10px] tracking-[0.3em] uppercase">
