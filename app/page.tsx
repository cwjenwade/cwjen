  ...
  return (
    <div className="min-h-screen bg-[#F8F8EC] font-sans text-[#3A4535] overflow-x-hidden selection:bg-[#E2C351] selection:text-white">
      ...
      <section className="relative w-full h-[60vh] md:h-[80vh] overflow-hidden">
         <div className="absolute inset-0 bg-black/20 z-10"></div> {/* 遮罩讓文字更清楚 */}
         <img 
           src={BANNERS.b04.src} 
           alt="Banner 04" 
         ...
         <div className="absolute inset-0 flex items-center justify-center z-20">
            <h2 className="text-white text-4xl md:text-6xl font-serif font-bold tracking-widest drop-shadow-lg border-b-2 border-[#E2C351] pb-4">
              {BANNERS.b04.text}
            </h2>
         </div>
      </section>
      ...
      {/* ================= BLOCK 1: 生活 (Life) ================= */}
      <section className="py-24 bg-[#A3BFA7]/10">
        <div className="max-w-6xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          
          <div className="order-2 lg:order-1 relative h-[500px]">
             {/* 拼貼元素保留 */}
             <div className="absolute top-10 left-10 w-[70%] z-10 shadow-xl bg-white p-2 rotate-2 hover:rotate-0 transition-all duration-500">
      ...
      <section className="relative w-full h-[50vh] md:h-[70vh] overflow-hidden">
         ...
         />
         <div className="absolute bottom-12 left-6 md:left-24 z-20 max-w-2xl">
            <p className="text-white text-3xl md:text-5xl font-serif font-bold leading-tight drop-shadow-md">
              {BANNERS.b03.text}
            </p>
         </div>
      </section>
      ...
      <section className="relative w-full h-[40vh] md:h-[60vh] overflow-hidden flex items-center justify-center">
         ...
         />
         <div className="relative z-20 bg-white/80 backdrop-blur-sm p-8 md:p-12 rounded-none md:rounded-lg shadow-2xl max-w-3xl text-center mx-4">
            <p className="text-[#2F3A29] text-2xl md:text-3xl font-serif font-bold">
              {BANNERS.b02.text}
            </p>
         </div>
      </section>
      ...
      {/* ================= BLOCK 3: 愛 (Love) ================= */}
      <section className="bg-[#E2C351]/10 border-b border-[#E2C351]/30 pb-24">
        
        {/* Banner 4: 愛的渴望 (b01) - 作為區塊開頭 */}
        <div className="relative w-full h-[60vh] md:h-[80vh] overflow-hidden mb-16">
           ...
           />
           <div className="absolute bottom-0 left-0 w-full p-10 md:p-20 z-20 text-center">
              <Heart size={40} className="text-white mx-auto mb-6 fill-current opacity-80" />
        ...
        <div className="max-w-5xl mx-auto px-6">
          <div className="text-center mb-16">
             <h2 className="text-3xl md:text-5xl font-serif font-bold text-[#2F3A29] mb-4">
               往內看的旅程
             </h2>
             <p className="text-lg text-[#5C6155]">
               嘗試喚醒看看。停頓一下，回到你自己。
             </p>
          </div>
